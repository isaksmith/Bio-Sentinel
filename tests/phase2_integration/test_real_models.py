...
These tests verify that the MegaDetectorV5Wrapper and MegaDetectorV6Wrapper
conform to the ConservationModel interface.  They require heavy dependencies
(torch, ultralytics, PytorchWildlife) and model weight downloads, so they
are marked ``integration`` and skipped by default in CI.
